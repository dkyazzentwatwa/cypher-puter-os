...
| [Cypher AirTag](apps/cypher-airtag/README.md) | `cypher-airtag` | `cypher-airtag.bin` | `cardputer-adv` | `/cypher-airtag/` | Press Back (`Del`) from the Home screen and confirm with `Enter`, or type `return` over serial. |
