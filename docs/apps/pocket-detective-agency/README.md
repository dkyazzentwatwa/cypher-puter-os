...
| Field | Value |
| --- | --- |
| Catalog slug | `pocket-detective-agency` |
| SD binary | `/cypher-puter/apps/pocket-detective-agency.bin` |
...
| Extra SD paths | `/cardputer-game-os/saves/pocket-detective-agency/save.sav` |
| Return path | Use the imported game's title-screen return control, usually `Backspace` or `Q`. |
| Package note | Imported Cardputer Game OS title: Notebook mystery. Cypher OS packages the individual game binary, not the nested Game OS launcher. |
